...
call mvn install:install-file -Dfile=ik-analyzer-2012_u6.jar -DgroupId=org.wltea.ik-analyzer -DartifactId=ik-analyzer -Dversion=2012_u6 -Dpackaging=jar -DgeneratePom=true
pause 
