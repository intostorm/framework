...
public class SecurityService implements ISecurityService {
	...
	public SecurityToken login(
			...
			String passwd,
			boolean rememberme,
			String validateCode) throws UserNotFoundException, UserNotAvailableException, WrongPasswordException, WrongValidateCodeException {
	...
	@Override
	public SecurityToken login(HttpServletResponse response, String[] usernames, String passwd, boolean rememberme)
		...
		if (!user.getPasswd().equals(passwd) && !user.getPasswd().equals(MD5.toMD5(passwd)))
