...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="${pageContext.request.contextPath}/scripts/ztree/zTreeStyle.css" />
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/ztree/jquery.ztree.all-3.4.min.js"></script>
